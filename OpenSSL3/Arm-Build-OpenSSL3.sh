# work=$HOME/build/openssl3; mkdir -p $work; cd $work; git clone https://github.com:/devizer/azure-pipelines-agent-in-docker; cd OpenSSL3; git pull; bash Arm-Build-OpenSSL3.sh
