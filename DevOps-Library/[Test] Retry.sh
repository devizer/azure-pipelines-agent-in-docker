...
RetryOnFail curl -o "$(Get_Tmp_Folder)/google dot com.html" -kfSL https://google.com

echo

Colorize Cyan "Validate https://no-such-suite.com is missing"
err=
RetryOnFail curl -o "$(Get_Tmp_Folder)/no such site.html" -kfSL https://no-such-suite.com || err=err
