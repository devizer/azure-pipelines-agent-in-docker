...
echo "Tag devizer/Universe.SqlInsights:        [$(Get-GitHub-Latest-Release devizer Universe.SqlInsights)]"
echo "Tag devizer/Universe.SqlInsights (beta): [$(Get-GitHub-Latest-Release devizer Universe.SqlInsights --pre)]"
echo "Tag powershell/powershell:               [$(Get-GitHub-Latest-Release powershell powershell)]"
echo "Tag powershell/powershell (beta):        [$(Get-GitHub-Latest-Release powershell powershell --pre)]"
