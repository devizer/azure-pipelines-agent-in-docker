...
# --with-libssh2=$OPENSSL_HOME: i386: ok, x86_64 fail
# ----disable-werror
./configure --with-ldap-lib=$OPENSSL_HOME --with-brotli=$OPENSSL_HOME --with-zstd=$OPENSSL_HOME --with-nghttp2=$OPENSSL_HOME --with-ssl=$OPENSSL_HOME --with-openssl=$OPENSSL_HOME --prefix=$OPENSSL_HOME |& tee "$CONFIG_LOG/curl.txt"
